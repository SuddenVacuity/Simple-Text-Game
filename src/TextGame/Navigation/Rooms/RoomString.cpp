...
{	
	...
	std::string roomString[][roomStringVal] =
	{
		...
		{ "[3_forest]", 
		/*name, desc*/"Forest", "A large forest. There are trees here and not much else.",
		/*basic secenery action*/"Nothing here.", "The trees are so thick you can't contunue.", "It's a tree.", "It's much darker over here.", "[3_7]", "[3_8]", "[3_9]",
		/*signs and messages*/"Goals:", "Reach level 5", "Don't Die", "[3_13]", "[3_14]", "[3_15]", "[3_16]", "[3_17]",
		/*signs and messages*/"Don't get lost in the thick trees.", "[3_19]", "[3_20]", "[3_21]", "[3_22]", "[3_23]", "[3_24]", "[3_25}", },
		{ "[4_town]", 
		/*name, desc*/"Town", "[Town Description]", 
		/*basic secenery action*/"Nothing here.", "Nothing happened.", "[4_5]", "[4_6]", "[4_7]", "[4_8]", "[4_9]",
		/*signs and messages*/"Town Info 1", "Town Info 2", "Town Info 3", "[4_13]", "[4_14]", "[4_15]", "[4_16]", "[4_17]",
