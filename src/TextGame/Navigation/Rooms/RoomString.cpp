...
{	
	...
	std::string roomString[][roomStringVal] =
	{
		...
		{ "[1_test]",
		/*name, desc*/"Testing Room", "[1_2]",
		/*basic secenery action*/"[1_3]", "It's a test wall.", "[1_5]", "[1_6]", "[1_7]", "[1_8]", "[1_9]",
		/*signs and messages*/"Welcome to the Testing Room", "This is a room made just for testing mechanics.", "The room is filled with various test functions.", "[1_13]", "[1_14]", "[1_15]", "[1_16]", "[1_17]",
